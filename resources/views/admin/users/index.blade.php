                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="border-b">
                                            ...
                                            <td
                                                class="text-sm flex text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <a class="bg-indigo-700 me-2 p-1 rounded text-white"
                                                    href="{{route('admin.users.show', $user->id)}}">roles</a>
                                                <form onsubmit="return alert('sei sicuro di eliminare l'utente?)"
